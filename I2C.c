...
void I2C_Init(void)
{
	...
	/*
	* Taken from INA260 datasheet:
	* low clock period = 1.3 us
	* high clock period = .6 us
	* data setup time = 1.1 us
	* data hold time = .01 us
	* START condition hold time = .1 us
	* STOP condition setup time = .1 us
	*/
	I2C1->TIMINGR = 0x0000;
...
int8_t I2C_Start(I2C_TypeDef *I2Cx, uint32_t DevAddress, uint8_t Size, uint8_t Direction)
{
	...
	// Direction = 0: Master requests a write transfer
	// Direction = 1: Master requests a read transfersss
...
int8_t I2C_ReceiveData(I2C_TypeDef *I2Cx, uint8_t DeviceAddress, uint8_t *pData, uint8_t Size)
{
	...
	I2C_Start(I2Cx, DeviceAddress, Size, READ_FROM_SLAVE); // 0 = write, 1 = read
